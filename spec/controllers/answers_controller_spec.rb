...
describe AnswersController do
  ...
  let(:valid_attributes) { { "answer_type" => "" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved answer as @answer" do
        ...
        post :create, {:answer => { "answer_type" => "invalid value" }}, valid_session
        assigns(:answer).should be_a_new(Answer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested answer" do
        ...
        Answer.any_instance.should_receive(:update).with({ "answer_type" => "" })
        put :update, {:id => answer.to_param, :answer => { "answer_type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the answer as @answer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Answer.any_instance.stub(:save).and_return(false)
        put :update, {:id => answer.to_param, :answer => { "answer_type" => "invalid value" }}, valid_session
        assigns(:answer).should eq(answer)
      end
