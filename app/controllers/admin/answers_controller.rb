class Admin::AnswersController < Admin::AdminController
  ...
  private
    ...
    def answer_params
      params.require(:answer).permit(:answer_type_id, :placeholder, :label_text, :help_block, :css_class, :disabled, :required, :query_string, :element_ajax, :ajax_url, answer_collections_attributes: [ :text, :value, :_destroy, :event_js ])
    end
end
